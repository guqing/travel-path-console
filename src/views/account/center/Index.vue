      ...
      <a-col :md="24" :lg="8">
        <a-card :bordered="false">
          ...
          <div class="account-center-detail">
            <p>
              <a-icon type="crown" />
              <a-tag v-for="(item, index) in userInfo.roleNames" :key="index">{{
                item
              }}</a-tag>
            </p>
            ...
            <p v-if="userInfo.mobile" title="手机号">
              <a-icon type="phone" />{{ userInfo.mobile }}
            </p>
            ...
            >
              ...
              >
                <a
                  ...
                  @click="handleUnbindSocial(item.provider)"
                >
                  取消关联
                </a>
                <a
                  slot="actions"
                  v-else
                  @click="handleBindSocialAccount(item.provider)"
                >
                  关联
                </a>
                <a-list-item-meta>
